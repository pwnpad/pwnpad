...
if [ "$(uname -m)" != "x86_64" ]; then
    ...
    docker rmi platypew/pwnpad:lite-arm64
    docker rmi platypew/pwnpad:latest-arm64
else
    ...
    docker rmi platypew/pwnpad:lite-amd64
    docker rmi platypew/pwnpad:latest-amd64
fi
